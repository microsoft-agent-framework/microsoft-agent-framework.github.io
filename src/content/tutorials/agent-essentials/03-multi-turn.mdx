...
prerequisites:
  ...
  - "Completion of 'Connect Your Agent to External Tools'"
...
envVars:
  ...
  - "OPENAI_MODEL_NAME"
runCommands:
  - "dotnet new console -n IncidentTriage.MultiTurn -f net10.0"
  - "cd IncidentTriage.MultiTurn"
  - "dotnet add package Microsoft.Agents.AI.OpenAI"
  - "dotnet add package Azure.AI.OpenAI"
  - "dotnet restore"
  - "dotnet run"
expectedOutput:
  - "The agent remembers the incident details from the first turn."
  - "The agent correctly identifies 'West Europe' or 'Checkout' in the follow-up question."
next: "/learn/agent-essentials/memory"
---
