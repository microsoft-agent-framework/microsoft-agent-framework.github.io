...
prerequisites:
  ...
  - "Access to an AI Provider (Azure OpenAI or a locally hosted OpenAI-compatible service like Ollama/LM Studio)"
  - "Proper authentication (Azure CLI sign-in or provider API keys)"
envVars:
...
runCommands:
  ...
  - "dotnet run"
expectedOutput:
  - "The app prints a full triage response for the checkout incident."
  - "The app prints a second response as streaming updates arrive."
next: "/learn/agent-essentials/add-tools"
---
