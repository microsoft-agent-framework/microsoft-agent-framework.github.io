...
prerequisites:
  ...
  - "Completion of 'Persist Conversations and Smart Memory'"
  - "Azure Functions Core Tools installed"
  - "Docker Desktop (for the DTS emulator)"
envVars:
  - "AZURE_OPENAI_ENDPOINT"
  - "AZURE_OPENAI_DEPLOYMENT_NAME"
runCommands:
  - "dotnet new func --name IncidentTriage.Host --worker-runtime dotnet-isolated"
  ...
  - "func start"
expectedOutput:
  - "The Azure Functions host starts and exposes a local Agent endpoint."
  - "The agent processes a cURL request and returns a JSON triage response."
next: "/learn/advanced-orchestration/beyond-agents"
---
...
```
    ...
    <div class="solid-callout solid-callout-info mt-6">
      ...
      <p class="text-xs text-indigo-900/80 leading-relaxed">
        To scaffold and run your agent host, you need the **Azure Functions Core Tools (v4.x)**. If you don't have them yet, [follow the official installation guide](https://learn.microsoft.com/en-us/azure/azure-functions/functions-run-local) for your platform.
      </p>
    </div>
  </div>
</details>
...
**What's next?** 
While a single agent is powerful, real-world complexity often requires multiple components working together. In the **[Advanced Orchestration](/learn/advanced-orchestration/beyond-agents)** journey, you'll learn how to move beyond single-turn reasoning and build robust **Compound AI Systems** using Workflows and Orchestrators.
