...
prerequisites:
  ...
  - "Completion of 'Orchestrate Multi-Step Workflows'"
next: "/learn/advanced-orchestration/host-your-workflow"
---
...
In the **[next tutorial](/learn/advanced-orchestration/host-your-workflow)**, we will take this resilient assembly line and host it as a scalable API using Azure Functions.
