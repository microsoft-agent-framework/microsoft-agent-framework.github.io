...
hosting: "Console app"
prerequisites:
  - "Completion of the Agent Essentials path"
next: "/learn/advanced-orchestration/orchestrate-workflows"
---
...
<div class="premium-gradient border border-indigo-100 rounded-3xl p-8 my-12 shadow-sm relative overflow-hidden">
...
In the **[next tutorial](/learn/advanced-orchestration/orchestrate-workflows)**, we will build Jordan's first professional assembly line: a multi-step **Incident Triage Workflow**.
