...
prerequisites:
  ...
  - "Basic understanding of Agent Tools"
  - "Access to an AI Provider"
runCommands:
  - "dotnet new console -n Agent.SemanticToolSearch -f net10.0"
  - "cd Agent.SemanticToolSearch"
...
expectedOutput:
  - "The agent identifies it needs a tool not currently loaded."
  - "The SearchTools function is invoked to find relevant tools."
  - "Relevant tools (e.g., GetWeather) are dynamically added to the agent."
  - "The agent successfully uses the newly loaded tool."
---
